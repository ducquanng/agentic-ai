...
Machine-readable data behind the MSc thesis *"A Model-Validation-Ready Risk
Taxonomy, Metrics, and Comparative Scoring Framework for Agentic AI in Financial
Institutions"* (University of Amsterdam; research internship at ING, Model Risk
Management).
